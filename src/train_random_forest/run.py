...
def go(args):
    ...
    train_local_path = run.use_artifact(args.trainval_artifact).file()
    ...
    # HINT: use wandb.Artifact to create a  n artifact. Use args.output_artifact as artifact name, "model_export" as
